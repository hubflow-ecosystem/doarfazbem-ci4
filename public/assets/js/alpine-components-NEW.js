...
// ==============================================
window.donationForm = function(campaignId, campaignType = 'medical') {
    return {
        // State
        amount: 50,
        paymentMethod: 'pix',
        donorPaysGatewayFee: false,
        donateToPlatform: true, // Novo: checkbox para doar 1% para plataforma
        ...
        get subtotal() {
            ...
            if (this.donateToPlatform) {
                total += this.platformFee;
            }
